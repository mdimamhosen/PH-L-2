...
CREATE TABLE "doctor_schedules" (
    ...
    CONSTRAINT "doctor_schedules_pkey" PRIMARY KEY ("doctorId","seheduleId")
);
...
-- AddForeignKey
ALTER TABLE "doctor_schedules" ADD CONSTRAINT "doctor_schedules_seheduleId_fkey" FOREIGN KEY ("seheduleId") REFERENCES "schedules"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
