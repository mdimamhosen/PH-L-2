...
const studnet_constant_1 = require('./studnet.constant');
const getAllStudentsFromDB = query =>
  __awaiter(void 0, void 0, void 0, function* () {
    const studentQueryBuilder = new QueryBuilder_1.default(
      ...
      .searchTerm(studnet_constant_1.studentSearchableFields)
      .filter()
      .sort()
      .pagination()
      .fields();
...
const updateStudentIntoDB = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { name, guardian, localGuardian } = payload,
      remainingStudentData = __rest(payload, [
        'name',
        'guardian',
        'localGuardian',
      ]);
...
const deleteStudentFromDB = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const deletedStudent = yield student_model_1.Student.findOneAndUpdate(
        { id },
        { isDeleted: true },
        { new: true, session },
      );
