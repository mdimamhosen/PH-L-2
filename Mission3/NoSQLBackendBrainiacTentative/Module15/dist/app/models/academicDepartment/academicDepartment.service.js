...
const getAllAcademicDepartmentsFromDB = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result =
      yield academicDepartment_model_1.AcademicDepartment.find().populate(
        'academicFaculty',
      );
    return result;
  });
const getSingleAcademicDepartmentFromDB = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result =
...
const updateAcademicDepartmentIntoDB = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result =
