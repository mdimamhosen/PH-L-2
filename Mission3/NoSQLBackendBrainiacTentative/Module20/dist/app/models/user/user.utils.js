...
exports.genarateAdminId = exports.genarateFacultyId = exports.findLastFacultyId = exports.genarateStudentId = void 0;
...
const genarateStudentId = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const prevStudentId = yield findLastStudentId();
    const prevStudentIdYear = prevStudentId === null || prevStudentId === void 0 ? void 0 : prevStudentId.slice(0, 4);
    const prevStudentIdCode = prevStudentId === null || prevStudentId === void 0 ? void 0 : prevStudentId.slice(4, 6);
    const prevStudentIdIncrement = prevStudentId === null || prevStudentId === void 0 ? void 0 : prevStudentId.slice(6, 10);
    const currentStudentIdYear = payload.year;
    const currentStudentIdCode = payload.code;
    if (prevStudentIdYear === currentStudentIdYear &&
