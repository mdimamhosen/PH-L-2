...
const getSingleStudent = (0, CatchResponse_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
...
const getAllStudents = (0, CatchResponse_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateStudent = (0, CatchResponse_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
...
const deleteStudent = (0, CatchResponse_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
