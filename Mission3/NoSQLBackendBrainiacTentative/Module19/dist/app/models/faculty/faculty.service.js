...
const updateFacultyIntoDb = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const { name } = payload, remaingFacultyData = __rest(payload, ["name"]);
...
const deleteFacultyFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const deletedFauculty = yield faculty_model_1.Faculty.findByIdAndUpdate(id, {
            isDeleted: true,
        }, {
            new: true,
            session,
        ...
        const deletedUser = yield user_model_1.User.findByIdAndUpdate(userId, {
            isDeleted: true,
        }, {
            new: true,
            session,
