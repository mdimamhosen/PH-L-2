...
const createAcademicSemester = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (academicSemester_const_1.SemisterCodeMapper[payload.code] !== payload.name) {
        throw new AppError_1.AppError(404, 'Semester code and name does not match');
    }
...
const updateAcademicSemesterFromDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicSemester_model_1.AcademicSemesterModel.findByIdAndUpdate({ _id: id }, payload, {
        new: true,
    });
    return result;
});
